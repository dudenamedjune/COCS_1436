...
let precentageOfSales = 0.58;
let companySales = 8.6e6;
let predictedSales = companySales * precentageOfSales;
print("Company is predicted to generate $\(predictedSales)")
